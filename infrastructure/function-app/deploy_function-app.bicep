...
param containerImage string = 'ghcr.io/smalls1652/entramfaprefillinator-funcapp:sha-6843da6'

//var randomString = uniqueString(subscription().id, resourceGroup().id, resourceBaseName)
...
resource containerApp 'Microsoft.Web/sites@2023-01-01' = {
...
output functionAppResourceId string = containerApp.id
